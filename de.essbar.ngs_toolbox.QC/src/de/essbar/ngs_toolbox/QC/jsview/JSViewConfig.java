 ...
 */
public final class JSViewConfig {
    ...
    private static final NodeLogger LOGGER = NodeLogger.getLogger(JSViewConfig.class);
    ...
    //    if (m_jsCode == null) {
            try {
                m_jsCode = IOUtils.toString(JSViewConfig.class.getResource(DEFAULT_SCRIPT_JS), Charsets.UTF_8);
            } catch (IOException e) {
    ...
    //    }
      ...
      //  if (m_cssCode == null) {
            try {
                m_cssCode = IOUtils.toString(JSViewConfig.class.getResource(DEFAULT_SCRIPT_CSS), Charsets.UTF_8);
            } catch (IOException e) {
