 ...
 */
package de.essbar.ngs_toolbox.IO.knime.nodes.ListDirImporter;
...
/**
 * Dialog component to choose multiple directories at once, as input for a KNIME
 * workflow.
 * 
 * @author roettig, aiche, neubert
 */
public class DialogComponentMultiDirChooser extends DialogComponent {
     ...
     */
    public DialogComponentMultiDirChooser(SettingsModelStringArray model) {
        super(model);
