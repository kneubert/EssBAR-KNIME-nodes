 ...
 */
public class IndexReaderNodePlugin extends Plugin {
    // The shared instance.
    private static IndexReaderNodePlugin plugin;

    /**
     * The constructor.
     */
    public IndexReaderNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static IndexReaderNodePlugin getDefault() {
        return plugin;
    }
