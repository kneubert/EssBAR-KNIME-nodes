...
/**
 * Helper class to compare and get Indextypes from file names.
 * 
...
public class IndexTypeHelper {
    ...
    public static String[] getExtensionsByIndexType (String index_type) {
        ...
        for (int i = 0; i < types.length; i++) {
            ...
            if (index.compareTo(index_type) == 0) {
                ext_list.addAll(ext);
            }
     ...
     */
    public static List<String> getAllIndexTypes() {
    ...
    public static String getRepresentativeExtensions() {
        ...
        for (int i = 0; i < types.length; i++) {
            ...
            if (valid_extensions.isEmpty()) {
                // Specify extension including the dot ".".
                valid_extensions  = "." + ext.get(0);
            }
            else {
