...
public final class IndexHistoryPanel extends JPanel {
     ...
     */
    /*
    public IndexHistoryPanel(final String historyID, final String... suffixes) {
...
*/
     ...
     *            on.
     * @deprecated use {@link #IndexHistoryPanel(FlowVariableModel, String, LocationValidation, String...)} instead in
     *             order to specify what kind of location validation to perform
     */
    /*
    @Deprecated
    public IndexHistoryPanel(final FlowVariableModel fvm,
    ...
    */
     ...
     * @param showErrorMessage if true there are error messages if the file exists or the path is not available and so
     *            on.
     * @deprecated use {@link #IndexHistoryPanel(String, LocationValidation)} instead in order to specify what kind of
     *             location validation to perform
     */
    /*
    @Deprecated
    public IndexHistoryPanel(final String historyID,
    ...
    */
    ...
    private String getOutputFileName() {
        ...
        List<FileNameExtensionFilter> filters = createFiltersFromIndexes(m_indexes);
    ...
    private static List<FileNameExtensionFilter> createFiltersFromIndexes(final String... indexes) {
        //List<SimpleFileFilter> filters = new ArrayList<>(extensions.length);
        List<FileNameExtensionFilter> filters = new ArrayList<>(indexes.length);
        ...
        for (final String index : indexes) {
            ...
            if (index.isEmpty()) {
                ...
                filters.add(new FileNameExtensionFilter(index, extensions));
            }
            else {
                ...
                int lastDot = ext.lastIndexOf('.') == -1 ? 0 : ext.lastIndexOf('.') + 1;
                ext = ext.substring(lastDot);
                filters.add(new FileNameExtensionFilter(index + " Index", ext));
            }    
