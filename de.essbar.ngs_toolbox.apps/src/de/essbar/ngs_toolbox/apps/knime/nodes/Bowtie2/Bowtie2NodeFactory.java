...
/**
    @brief Bowtie2 Node Factory.
*/
public class Bowtie2NodeFactory extends GenericKnimeNodeFactory {
    
    private static final NodeLogger logger = NodeLogger.getLogger(Bowtie2NodeFactory.class);
    ...
    public Bowtie2NodeModel createNodeModel() {
        ...
        try {
            ...
            return new Bowtie2NodeModel(tmpConfig, PluginActivator
                    .getInstance().getPluginConfiguration());
        } catch (Exception e) {
            logger.error("Bowtie2 model instantiation failed", e);
        }
        return null;
    ...
    public GenericKnimeNodeDialog createNodeDialogPane() {
        ...
        try {
            tmpConfig = getNodeConfiguration();
            return new Bowtie2NodeDialog(tmpConfig);
        } catch (Exception e) {
            logger.error("Bowtie2 dialog instantiation failed", e);
        }
        return null;
    }
